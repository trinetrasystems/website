...
const AppSidebar = () => {
  ...
  return (
    <>
      <header className="fixed top-3 inset-x-3 md:top-4 md:inset-x-6 z-[60] mx-auto max-w-[1440px] rounded-2xl border border-border/60 bg-background/70 dark:bg-card/70 backdrop-blur-xl shadow-[0_8px_32px_-12px_rgba(0,0,0,0.25)]">
        <div className="flex h-16 md:h-[72px] w-full items-center justify-between gap-3 px-3 sm:px-4 md:px-5">
          ...
          >
            ...
            <img
              ...
              className="h-11 md:h-12 w-auto block dark:hidden transition-transform duration-300 group-hover:scale-[1.03]"
            />
            <img
              src="/logo/logo-dark.png"
              alt="Trinetra Systems"
              className="h-11 md:h-12 w-auto hidden dark:block transition-transform duration-300 group-hover:scale-[1.03]"
            />
          </a>
